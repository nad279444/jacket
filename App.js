...
export default function App() {
  return (
      ...
      <View style={globalStyles.iconContainer}>
          <View style={globalStyles.arrow}><AntDesign name="arrowleft" size={20} color="black" /></View>
          <View style={globalStyles.cart}><AntDesign name="shoppingcart" size={20} color="#587bcc" /></View>
      </View>
